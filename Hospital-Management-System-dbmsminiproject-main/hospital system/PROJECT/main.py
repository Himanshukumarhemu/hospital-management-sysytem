...
# app.config['SQLALCHEMY_DATABASE_URL']='mysql://username@localhost:port_number/databas_table_name'
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql://root@localhost:3307/hmdms'
db=SQLAlchemy(app)
